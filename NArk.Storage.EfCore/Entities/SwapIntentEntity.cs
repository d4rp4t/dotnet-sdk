...
/// <summary>Persisted non-interactive swap intent (the banco BTC↔asset covenant swap).</summary>
public class SwapIntentEntity
{
    ...
    public SwapIntentType Type { get; set; }
    ...
    public SwapIntentStatus Status { get; set; }
    ...
    public static void Configure(EntityTypeBuilder<SwapIntentEntity> builder, ArkStorageOptions options)
    {
